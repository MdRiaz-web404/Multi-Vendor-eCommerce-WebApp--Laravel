            ...
            <div id="kt_account_settings_profile_details" class="collapse show">
                ...
                <div class="card-body border-top p-9">
                        ...
                        <div class="col-lg-8">
                            ...
                            <form action="{{route('photoupload')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="image-input image-input-outline" data-kt-image-input="true">
                                    ...
                                    <div class="image-input-wrapper w-125px h-125px" style="@if (auth()->user()->avatar)
                                        background-image: url('{{ asset('dashboard_assets') }}/profile_photos/{{auth()->user()->avatar}}'
                                        @else
                                        background-image: url('{{ asset('dashboard_assets') }}/default_profile_photo.jpg'
                                        @endif"></div>
                                ...
                                <div class="card-footer d-flex justify-content-end py-6 px-9">
                                    <button type="submit" class="btn btn-primary" id="kt_account_profile_details_submit">Save Photo</button>
                                </div>
                            </form>
                            <!--end::Image input-->
                            <!--begin::Hint-->
                    ...
                    <form action="{{route('admindetails')}}" method="POST">
                        ...
                        <div class="row mb-6">
                            <!--begin::Label-->
                            <label class="col-lg-4 col-form-label required fw-bold fs-6">Current Pasword</label>
                            <!--end::Label-->
                            <!--begin::Col-->
                            <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        ...
                        <div class="row mb-6">
                            <!--begin::Label-->
                            <label class="col-lg-4 col-form-label required fw-bold fs-6">New Pasword</label>
                            <!--end::Label-->
                            <!--begin::Col-->
                            <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        ...
                        <div class="row mb-6">
                            <!--begin::Label-->
                            <label class="col-lg-4 col-form-label required fw-bold fs-6">Confirm Pasword</label>
                            <!--end::Label-->
                            <!--begin::Col-->
                            <div class="col-lg-8 fv-row fv-plugins-icon-container">
