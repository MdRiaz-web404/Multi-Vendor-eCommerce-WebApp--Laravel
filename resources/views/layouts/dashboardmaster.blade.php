...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../">
		<title>Stowaa - Admin Dashboard</title>
		<meta charset="utf-8" />
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="page d-flex flex-row flex-column-fluid">
				...
				<div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
					<!--begin::Brand-->
					<div class="aside-logo flex-column-auto" id="kt_aside_logo" style="background-color: #fff !important;">
						<!--begin::Logo-->
						<a href="{{route('home')}}">
							<img alt="Logo" src="{{ asset('frontend_assets') }}/images/logo/logo_1x.png" class="h-25px logo" />
						</a>
						<!--end::Logo-->
						<!--begin::Aside toggler-->
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true" data-kt-menu-expand="false">
								<div class="menu-item here show menu-accordion">
									<span class="menu-link">
										...
										<a href="{{route('home')}}" class="menu-title">Dashboards</a>
									</span>
                                ...
                                <div  class="menu-item menu-accordion">
									<span class="menu-link">
										...
										<a target="_blank" href="{{route('index')}}" class="menu-title">Visit Website</a>
									</span>
								</div>
                                ...
                                <div class="menu-item menu-accordion">
									<span class="menu-link">
										...
										<a href="{{route('admin.index')}}" class="menu-title">Admin</a>
									</span>
								</div>
                                @endif
								<div class="menu-item">
                                    									...
                                    									<div class="menu-sub menu-sub-accordion menu-active-bg">
                                    										<div  class="menu-item menu-accordion">
                                    											<span class="menu-link">
                                    												...
                                    												<a href="{{ route('category.create')}}" class="menu-title">Add Category</a>
                                    											</span>
                                    										</div>
                                    									</div>
                                    									<div class="menu-sub menu-sub-accordion menu-active-bg">
                                    										<div class="menu-item menu-accordion">
                                    											<span class="menu-link">
                                    												...
                                    												<a href="{{route('category.index')}}" class="menu-title">List of Categories</a>
                                    											</span>
                                    										</div>
                                    									</div>
                                    								</div>
                                        ...
                                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                                            <div  class="menu-item menu-accordion">
                                                <span class="menu-link">
                                                    ...
                                                    <a href="{{ route('team.create')}}" class="menu-title">Add Member</a>
                                                </span>
                                            </div>
                                        </div>
                                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                                            <div class="menu-item menu-accordion">
                                                <span class="menu-link">
                                                    ...
                                                    <a href="{{route('team.index')}}" class="menu-title">List of Members</a>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                                            <div  class="menu-item menu-accordion">
                                                <span class="menu-link">
                                                    ...
                                                    <a href="{{ route('service.create')}}" class="menu-title">Add Service</a>
                                                </span>
                                            </div>
                                        </div>
                                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                                            <div class="menu-item menu-accordion">
                                                <span class="menu-link">
                                                    ...
                                                    <a href="{{route('service.index')}}" class="menu-title">List of Services</a>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                                            <div  class="menu-item menu-accordion">
                                                <span class="menu-link">
                                                    ...
                                                    <a href="{{ route('product.create')}}" class="menu-title">Add Product</a>
                                                </span>
                                            </div>
                                        </div>
                                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                                            <div class="menu-item menu-accordion">
                                                <span class="menu-link">
                                                    ...
                                                    <a href="{{route('product.index')}}" class="menu-title">List of Products</a>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                                            <div  class="menu-item menu-accordion">
                                                <span class="menu-link">
                                                    ...
                                                    <a href="{{ route('variation.index')}}" class="menu-title">Add Variation</a>
                                                </span>
                                            </div>
                                        </div>
                                        {{-- <div class="menu-sub menu-sub-accordion menu-active-bg">
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            <div class="menu-item menu-accordion mb-1">
                                                <span class="menu-link">
                                                    ...
                                                    <a href="{{route('vendor.list')}}" class="menu-title">Vendors</a>
                                                    <span class="menu-arrow"></span>
                                                </span>
                                            </div>
                                        </div>
								...
								<div class="d-flex align-items-stretch flex-shrink-0">
									...
									<div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
										...
										<div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
											@if (auth()->user()->avatar)
                                            <img src="{{ asset('dashboard_assets') }}/profile_photos/{{auth()->user()->avatar}}" alt="">
                                            @else
                                            <img src="{{ asset('dashboard_assets') }}/default_profile_photo.jpg" alt="">
                                            @endif
										</div>
