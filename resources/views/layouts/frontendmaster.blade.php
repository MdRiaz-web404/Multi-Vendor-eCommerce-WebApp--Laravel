                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col col-md-3">
                            <a href="{{route('vendor_account')}}" target="_blank" class="header_hotline"><strong>Open Your Shop</strong></a>
                        </div>
                        <div class="col col-md-3">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col col-md-3">
                            <ul class="header_icons_group ul_li_right">
                                 @guest
                                    <li>
                                       <a class="header_icons_group ul_li_right" href="{{ route('account') }}">Login|Register</a>
                                   </li>
                                 @endguest
                                 @auth
                                    <li>
